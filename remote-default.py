...
def main():
    ...
    p.add_argument('-c', '--configure', action='store_true', help='Config remote')
    p.add_argument('-i', '--install', action='store_true', help='Install')
    p.add_argument('-u', '--uninstall', action='store_true', help='Uninstall')
    p.add_argument('-r', '--remote-host', dest='host', help='Host (user@host)')
    p.add_argument('-k', '--ssh-key', dest='key', help='SSH key path')
    p.add_argument('-b', '--remote-browser', dest='browser', default='xdg-open', help='Browser cmd')
    
    # Log args
    p.add_argument('-E', '--enable-logging', action='store_true', help='Log on')
    p.add_argument('-D', '--disable-logging', action='store_true', help='Log off')
    p.add_argument('-l', '--log-level', dest='lvl', choices=['DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL'], help='Log lvl')
    p.add_argument('-f', '--log-file', dest='log_f', help='Log file path')
    p.add_argument('-s', '--show-log', action='store_true', help='Show log')
